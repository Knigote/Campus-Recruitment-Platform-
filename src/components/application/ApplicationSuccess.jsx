...
const ApplicationSuccess = () => (
  <div className="text-center">
    ...
    <h2 className="text-3xl font-bold mt-8 text-white drop-shadow-lg">Thank You!</h2>
    <p className="mt-2 text-cyan-200 drop-shadow">Your application has been received. We will be in touch regarding the next steps.</p>
